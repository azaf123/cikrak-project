            ...
            <div className={Style.content_item_1}>
              <div className={Style.content_item_textmaster_1}>
                ...
                <div className={Style.content_item_text}>
                  <h2>Bring Shopping Bag</h2>
                  <p>
                    Remember to bring reusable bags to the grocery store or for
                    any other shopping activities to reduce consumption of
                    disposable bags.
                  </p>
                </div>
              </div>
              <div className={Style.content_item_textmaster_1}>
                <div className={Style.content_item_text}>
                  <h2>Invest in a reusable water bottle.</h2>
                  <p>
                    Remember to bring reusable bags to the grocery store or for
                    any other shopping activities to reduce consumption of
                    disposable bags.
              ...
              <div className={Style.content_item_textmaster_1}>
                ...
                <div className={Style.content_item_text}>
                  ...
                  <p>
                    Think about how many disposable cups are used every day in
                    just your local coffee shop. Bringing a mug for your morning
                    coffee can reduce the amount of waste you produce annually.
                    Imagine how much waste we could reduce if we all made this
                    simple daily change!
                  </p>
                </div>
              </div>
              <div className={Style.content_item_textmaster_1}>
                <div className={Style.content_item_text}>
                  <h2>Refuse single-use items.</h2>
                  <p>
                    Take note on how often you rely on single-use items and
                    choose to replace them with more sustainable versions.
                    Refusing plastic straws and disposable cutlery when you go
                    out and bringing your own containers for leftovers are a few
              ...
              <div className={Style.content_item_textmaster_1}>
                ...
                <div className={Style.content_item_text}>
                  ...
                  <p>
                    Avoid products with microbeads. Facial scrubs and beauty
                    products containing plastic microbeads were banned in the
                    United States in 2015, but won’t be fully phased out until
                    2019. Read the labels when purchasing products and opt for
                    ones that contain natural scrubbing ingredients like salt or
                    sugar..{' '}
                  </p>
                </div>
              </div>
              <div className={Style.content_item_textmaster_1}>
                <div className={Style.content_item_text}>
                  <h2> Make sure your waste goes to the right place</h2>
                  <p>
                    Make sure your waste goes to the right place. Do your best
                    to ensure that the waste you dispose of ends up where it
                    should. Recycle the materials that are recyclable in your
                    area and make sure to reduce the likelihood of your garbage
                    ending up in the environment by keeping a lid on your trash
                    can when it’s outside.{' '}
                  </p>
                </div>
                <div className={Style.content_item_imageMaster}>
                  <img src={nanem} alt="" />
