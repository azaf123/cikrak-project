    ...
    return(
        ...
        <div className="flex">
            ...
            <div className="redeem">
                ...
                <h4 className="reedem text-2xl mx-20 font-bold text-main-blue "> Reedem Points</h4>
                    <Points/>
                </div>
            <div className="voucer mx-20 w-6/6 bg-white ">
                <div className="  text-2xl">
                    <a href="./voucher" className=" float-right text-sm text-main-blue" >Browse More</a>   
