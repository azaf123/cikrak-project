    ...
    return(
        <>
            ...
            <h4 className="reedem text-2xl   "> Reedem Points</h4>
                ...
                <a href="#" class="point inline-block mx-2 drop-shadow-lg my-3 p-6  bg-blue-100 rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><FontAwesomeIcon icon={faStar} className="text-yellow-400"/>  {userData.points} <pa className=" text-black text-sm">Points</pa></h5>
                    <p class="font-normal text-gray-700 dark:text-gray-400">There are vouchers waiting for you - 
