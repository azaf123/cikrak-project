...
return(
    ...
    <section className="container "> 
        <h4  className="text-sky-500 text-2xl">List Voucher</h4>
        <div className="row rounded-xl text-xl my-4 ml-4 bg-blue-100">
            <h6 className="font-bold">Food & Beverage</h6>
            {voucher.FoodBeverage.map((item,index)=>{
                return(
                    <div className="col-4 my-2 cursor-pointer  " key={index}> 
                        ...
                        (item.image, item.voucher, item.date, item.points)}>
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text float-right text-lg">{item.points}</p>
                            </div>
                        </div>
                    </div>                            
                )
            ...
            <div className="row my-4 ml-4 text-xl">
            <h6 className="font-bold">Entertaiment</h6>
            ...
            <div className="row rounded-xl text-xl my-4 ml-4  bg-blue-100">
            <h6 className="font-bold">Healthy&Beauty</h6>
